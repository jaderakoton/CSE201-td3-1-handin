...
void sort(double *global_telementary, int &global_telementary_current_size){
    for(int i=0;i<global_telementary_current_size; i=i+3){
        for(int j=0; j<global_telementary_current_size; j=j+3){
            if(global_telementary[j] > global_telementary[j+3]){
